<template>
						...
						<div id="product-info">
							...
							<h3 v-for="product in products" :key="product" style="color: black; margin-top: 50px; margin-bottom: 30px;">{{ product.name }}</h3>
							<div class="row">
								...
								<div id="product-details" class="col-xs-5 col-sm-5 col-md-5" style="margin-left:130px; border:1px solid;">
									...
									<!-- <p style="margin-top:20px;"><strong><img src="frontend/img/home/check.png">  Bảo hành: {{product.baohanh}}</img></strong></p> -->
